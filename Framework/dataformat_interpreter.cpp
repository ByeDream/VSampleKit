...
struct SurfaceFormatInfo
{
	...
	uint64_t m_bits[4];
	void (*m_encoder)(const SurfaceFormatInfo *__restrict info, uint32_t *__restrict dest, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat);
	void (*m_decoder)(const SurfaceFormatInfo *__restrict info, Framework::Reg32 *__restrict dest, const uint32_t *__restrict src, const Gnm::DataFormat dataFormat);
	uint64_t m_offset[4];
...
namespace
{
	...
	void encodeTextureChannelSharedExponent(uint32_t *__restrict dest, const Framework::Reg32 *__restrict source, const SurfaceFormatInfo * __restrict info)
	{
		Framework::Reg32 temp[3] = {source[0], source[1], source[2]};
	...
	void decodeTextureChannelSharedExponent(Framework::Reg32 *__restrict dest, const uint32_t *__restrict source, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUNorm(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsSNorm(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUScaled(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsSScaled(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUInt(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsSInt(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsSNormNoZero(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsFloat(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
		dest[0].f = Framework::unpackFloat(value[0], floatInfo[info->m_bits[0]].m_signBits, floatInfo[info->m_bits[0]].m_exponentBits, floatInfo[info->m_bits[0]].m_mantissaBits);
		dest[1].f = Framework::unpackFloat(value[1], floatInfo[info->m_bits[1]].m_signBits, floatInfo[info->m_bits[1]].m_exponentBits, floatInfo[info->m_bits[1]].m_mantissaBits);
		dest[2].f = Framework::unpackFloat(value[2], floatInfo[info->m_bits[2]].m_signBits, floatInfo[info->m_bits[2]].m_exponentBits, floatInfo[info->m_bits[2]].m_mantissaBits);
		dest[3].f = Framework::unpackFloat(value[3], floatInfo[info->m_bits[3]].m_signBits, floatInfo[info->m_bits[3]].m_exponentBits, floatInfo[info->m_bits[3]].m_mantissaBits);
	}

	void decodeTextureChannelsSrgb(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUBNorm(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUBNormNoZero(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUBInt(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
	...
	void decodeTextureChannelsUBScaled(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info)
	{
...
typedef void (*DecoderFunction)(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo *__restrict info);
...
namespace 
{
	void decodeTextureChannels(Framework::Reg32 *__restrict dest, const uint32_t *__restrict value, const SurfaceFormatInfo * __restrict info, const Gnm::TextureChannelType textureChannelType)
	{
	...
	void encodeTextureChannelsUNorm(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsSNorm(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUScaled(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsSScaled(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUInt(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsSInt(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsSNormNoZero(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsFloat(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
		dest[0] = Framework::packFloat(value[0].f, floatInfo[info->m_bits[0]].m_signBits, floatInfo[info->m_bits[0]].m_exponentBits, floatInfo[info->m_bits[0]].m_mantissaBits);
		dest[1] = Framework::packFloat(value[1].f, floatInfo[info->m_bits[1]].m_signBits, floatInfo[info->m_bits[1]].m_exponentBits, floatInfo[info->m_bits[1]].m_mantissaBits);
		dest[2] = Framework::packFloat(value[2].f, floatInfo[info->m_bits[2]].m_signBits, floatInfo[info->m_bits[2]].m_exponentBits, floatInfo[info->m_bits[2]].m_mantissaBits);
		dest[3] = Framework::packFloat(value[3].f, floatInfo[info->m_bits[3]].m_signBits, floatInfo[info->m_bits[3]].m_exponentBits, floatInfo[info->m_bits[3]].m_mantissaBits);
	}

	void encodeTextureChannelsSrgb(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUBNorm(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUBNormNoZero(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUBInt(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
	...
	void encodeTextureChannelsUBScaled(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info)
	{
...
typedef void (*EncoderFunction)(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info);
...
namespace 
{
	void encodeTextureChannels(uint32_t *__restrict dest, const Framework::Reg32 *__restrict value, const SurfaceFormatInfo *__restrict info, const Gnm::TextureChannelType textureChannelType)
	{
	...
	void swizzleRegs(Framework::Reg32 *__restrict dest, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat)
	{
	...
	void simpleEncoder(const SurfaceFormatInfo *__restrict info, uint32_t *__restrict dest, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat)
	{
		Framework::Reg32 tempSrc[4];
		uint32_t tempDest[4];
	...
	void simpleDecoder(const SurfaceFormatInfo *__restrict info, Framework::Reg32 *__restrict dest, const uint32_t *src, const Gnm::DataFormat dataFormat)
	{
		uint32_t tempSrc[4];
		Framework::Reg32 tempDest[4];
	...
	void sharedExponentEncoder(const SurfaceFormatInfo *__restrict info, uint32_t *__restrict dest, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat)
	{
		Framework::Reg32 tempSrc[4];
		uint32_t tempDest[4];
	...
	void sharedExponentDecoder(const SurfaceFormatInfo *__restrict info, Framework::Reg32 *__restrict dest, const uint32_t *src, const Gnm::DataFormat dataFormat)
	{
		uint32_t tempSrc[4];
		Framework::Reg32 tempDest[4];
	...
	void sharedChromaEncoder(const SurfaceFormatInfo *__restrict info, uint32_t *__restrict dest, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat)
	{
		Framework::Reg32 tempSrc[4];
		uint32_t tempDest[4];
	...
	void sharedChromaDecoder(const SurfaceFormatInfo *__restrict info, Framework::Reg32 *__restrict dest, const uint32_t *src, const Gnm::DataFormat dataFormat)
	{
		uint32_t tempSrc[4];
		Framework::Reg32 tempDest[4];
...
static const SurfaceFormatInfo g_surfaceFormatInfo[] =
{
	...
	DEFINE_SURFACEFORMATINFO(Gnm::kSurfaceFormat1          ,  1,  0,  0,  0, simpleEncoder, simpleDecoder),
	DEFINE_SURFACEFORMATINFO(Gnm::kSurfaceFormat1Reversed  ,  1,  0,  0,  0, simpleEncoder, simpleDecoder), 
};

void Framework::dataFormatEncoder(uint32_t *__restrict dest, uint32_t *__restrict destDwords, const Framework::Reg32 *__restrict src, const Gnm::DataFormat dataFormat)
{
...
void Framework::dataFormatDecoder(Framework::Reg32 *__restrict dest, const uint32_t *__restrict src, const Gnm::DataFormat dataFormat)
{
	Gnm::SurfaceFormat surfaceFormat = dataFormat.getSurfaceFormat();
	SCE_GNM_ASSERT(surfaceFormat < sizeof(g_surfaceFormatInfo)/sizeof(g_surfaceFormatInfo[0]));
	const SurfaceFormatInfo *info = &g_surfaceFormatInfo[dataFormat.getSurfaceFormat()];
