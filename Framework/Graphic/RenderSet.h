...
namespace Framework
{
	...
	public:
		...
		inline GPUResourceHandle		getColorSurfaceHandle(U32 slotID) const { SCE_GNM_ASSERT(slotID >= 0 && slotID < MAX_NUM_COLOR_SURFACE); return mColorHandle[slotID]; }
	...
	protected:
		...
		GPUResourceHandle				mColorHandle[MAX_NUM_COLOR_SURFACE]{ RESOURCE_HANDLE_INVALID, RESOURCE_HANDLE_INVALID, RESOURCE_HANDLE_INVALID, RESOURCE_HANDLE_INVALID };
