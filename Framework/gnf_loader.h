...
namespace Framework
{
	 ...
	 */
    GnfError loadTextureFromGnf(sce::Gnm::Texture *outTexture, const char *fileName, uint8_t textureIndex, Allocators* allocators);
	 ...
	 * @return Zero if successful; otherwise, a non-zero error code.
	 */
    GnfError loadTextureFromGnf(sce::Gnm::Texture *outTexture, const char *fileName, uint8_t textureIndex, IAllocator* allocator);
