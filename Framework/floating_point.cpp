...
uint32_t Framework::packFloat(float value, uint32_t signBits, uint32_t exponentBits, uint32_t mantissaBits)
{
	if(signBits == 0)
...
float Framework::unpackFloat(uint32_t value, uint32_t signBits, uint32_t exponentBits, uint32_t mantissaBits)
{
	f32 out;
...
int32_t Framework::convertFloatToInt(float value)
{
	return static_cast<int32_t>(floorf(value + 0.5f));
}

uint32_t Framework::convertFloatToUint(float value)
{
	return static_cast<uint32_t>(floorf(value + 0.5f));
}

uint32_t Framework::floatToFloat10(float value)
{
	return packFloat(value, 0, 5, 5);
}

uint32_t Framework::floatToFloat11(float value)
{
	return packFloat(value, 0, 5, 6);
}

uint32_t Framework::floatToFloat16(float value)
{
	return packFloat(value, 1, 5, 10);
}

uint32_t Framework::floatToFloat32(float value)
{
	return packFloat(value, 1, 8, 23);
}

float Framework::float10ToFloat(uint32_t value)
{
	return unpackFloat(value, 0, 5, 5);
}

float Framework::float11ToFloat(uint32_t value)
{
	return unpackFloat(value, 0, 5, 6);
}

float Framework::float16ToFloat(uint32_t value)
{
	return unpackFloat(value, 1, 5, 10);
}

float Framework::float32ToFloat(uint32_t value)
{
